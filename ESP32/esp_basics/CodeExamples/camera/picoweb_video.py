...
import picoweb
import utime
from esp_basics.CodeExamples import camera
import gc

SSID = "TNGBOX3689703"         # Enter your WiFi name (Server set identifier)
PASSWORD = "59968779516854631142"     # Enter your WiFi password
